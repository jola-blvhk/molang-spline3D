...
export default function Home() {
  return (
    <main className={`relative h-screen`}>
      <div className="absolute grid justify-center items-center top-40   w-64 h-40 right-[580px] ">
        <Image src={CloudImage} fill objectFit="contain" alt="cloud image" />
        <div className="text-center  z-[100] w-fit my-auto text-[#FF7661]">
          <p className="">
            Hover to interact.
          </p>
      ...
      <div className=" absolute  top-96 left-20  space-y-8">
        <h1 className="font-bold font-poppins  text-7xl text-[#FF9585]">
          Hi! I’m Molang{" "}
        </h1>
        <h2 className="font-medium  text-4xl text-[#FF7661] ">
